...
import { EyeIcon, EyeOffIcon, MailIcon, LockIcon, UserIcon, CalendarIcon, PhoneIcon } from 'lucide-react';
...
const LoginSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isSignup) {
        await signup(form.email, form.password, form.nombre, form.telefono, form.cumpleanos);
      } else {
  ...
  const toggleMode = () => {
    ...
    setError('');
    setValidationErrors({ email: '', password: '', confirmPassword: '', nombre: '', telefono: '' });
    setForm({
      email: '',
      password: '',
      confirmPassword: '',
